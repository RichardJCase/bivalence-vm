...
bool set_create(size_t width, pointer *set_ptr);
...
bool hash_create(size_t buckets, size_t width, bool (*hash_func)(void *), bool (*comp_func)(void *, void *), pointer *hash_ptr);
